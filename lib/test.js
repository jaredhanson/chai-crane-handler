...
/**
 * Register a callback to be invoked when handler `nack()`s response.
 *
 * @param {Function} cb
 * @return {Test} for chaining
 * @api public
 */
Test.prototype.nack = function(cb) {
  this._nack = cb;
  return this;
};
...
Test.prototype.dispatch = function(err) {
  var self = this
    , msg = new Message(function() {
        ...
        if (!self._nack) { throw new Error('msg#nack should not be called'); }
        self._nack.call(this, msg, requeue);
      })
    , before = this._msg;
